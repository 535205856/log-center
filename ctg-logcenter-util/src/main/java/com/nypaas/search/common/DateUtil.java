...
public class DateUtil {
     ...
     * 获取日当前日期，前几天后的日期
     */
    public static Date getDayBeforeDays(int days) {
     ...
     * @return
     */
    public static Date getDayAfterDays(int days) {
        gregorianCalendar.setTime(getNowDate());
        int day = gregorianCalendar.get(Calendar.DATE);
        gregorianCalendar.set(Calendar.DATE, day + days);
        return gregorianCalendar.getTime();
    }
    public static Date getDayAfterHours(Date date,int hours) {
        gregorianCalendar.setTime(date);
        int hour = gregorianCalendar.get(Calendar.HOUR);
        gregorianCalendar.set(Calendar.HOUR, hour + hours);
        return gregorianCalendar.getTime();
    }
